...
describe("Comment", () => {
  ...
  test("POST /comments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        commentCreationDate: CREATE_RESULT.commentCreationDate.toISOString(),
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          commentCreationDate:
            FIND_MANY_RESULT[0].commentCreationDate.toISOString(),
  ...
  test("GET /comments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        commentCreationDate: FIND_ONE_RESULT.commentCreationDate.toISOString(),
