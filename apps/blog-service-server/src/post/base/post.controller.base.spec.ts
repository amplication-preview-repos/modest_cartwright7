...
describe("Post", () => {
  ...
  test("POST /posts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        blogCreationDate: CREATE_RESULT.blogCreationDate.toISOString(),
  ...
  test("GET /posts", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          blogCreationDate: FIND_MANY_RESULT[0].blogCreationDate.toISOString(),
  ...
  test("GET /posts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        blogCreationDate: FIND_ONE_RESULT.blogCreationDate.toISOString(),
